import { assertExactKeys, assertStringArray, createTrustedCatalog, isPlainObject } from '../../a2ui-browser/src/catalog/runtime.mjs';
import { PROFILED_BUSINESS_MODEL_CATALOG_ID } from '../contracts.mjs';
  ...
  },
  {
    ...
    render: ({ component, dataModel, document }) => {
      ...
      for (const ref of component.activityRefs) {
        ...
        activities.append(semantic(element(document, 'span', '', activity.label), 'activity', ref));
      }
