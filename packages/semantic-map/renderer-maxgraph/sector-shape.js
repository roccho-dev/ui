...
const finiteStyle = (style, key, fallback) => {
  const value = Number(style?.[key]);
  return Number.isFinite(value) ? value : fallback;
};
const pointOnEllipse = (centerX, centerY, radiusX, radiusY, angleDegrees) => {
...
const outerArc = (canvas, centerX, centerY, radiusX, radiusY, fromAngle, toAngle) => {
...
export const SectorShape = createShapeType(function paintSector(canvas, x, y, width, height) {
