...
export const primitiveComponents = [
  ...
  defineComponent({ id: "ForEach", family: "layout", stability: "stable", description: "generic repeater over a state array", props: ["path", "as"], childrenPolicy: "templated", producesOutputKinds: ["html.element", "svg.element"] }),
  ...
  defineComponent({ id: "List", family: "layout", stability: "stable", description: "list container", props: ["rows"], producesOutputKinds: HTML_PRODUCES }),
