import { BaseGraph } from '../../semantic-map/vendor/maxgraph/view/BaseGraph.js';
import { Cell } from '../../semantic-map/vendor/maxgraph/view/cell/Cell.js';
import Geometry from '../../semantic-map/vendor/maxgraph/view/geometry/Geometry.js';
import Rectangle from '../../semantic-map/vendor/maxgraph/view/geometry/Rectangle.js';
import CellEditorHandler from '../../semantic-map/vendor/maxgraph/view/plugin/CellEditorHandler.js';
import ConnectionHandler from '../../semantic-map/vendor/maxgraph/view/plugin/ConnectionHandler.js';
import SelectionCellsHandler from '../../semantic-map/vendor/maxgraph/view/plugin/SelectionCellsHandler.js';
import SelectionHandler from '../../semantic-map/vendor/maxgraph/view/plugin/SelectionHandler.js';
import InternalEvent from '../../semantic-map/vendor/maxgraph/view/event/InternalEvent.js';
import { EdgeMarkerRegistry } from '../../semantic-map/vendor/maxgraph/view/style/marker/EdgeMarkerRegistry.js';
import { createArrow } from '../../semantic-map/vendor/maxgraph/view/style/marker/edge-markers.js';
import { PerimeterRegistry } from '../../semantic-map/vendor/maxgraph/view/style/perimeter/PerimeterRegistry.js';
import { RectanglePerimeter } from '../../semantic-map/vendor/maxgraph/view/style/perimeter/RectanglePerimeter.js';
