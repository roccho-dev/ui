...
`ui` owns the A2UI / SDUI component registry and the core/port package boundary.
...
| Purpose Atlas input fixtures | `tests/fixtures/purpose-atlas/**` |
| Purpose Atlas source references | `tests/reference/purpose-atlas-source/**` |
| Generated artifacts | Nix and CI outputs |
