...
assert.match(flake, /readmeProjectionReceipt = builtins\.readFile "\$\{self\}\/packages\/ui-projection-evidence\/readmeProjectionReceipt\.v1\.jsonl"/);
assert.match(flake, /role = "readmeProjectionReceipt"/);
