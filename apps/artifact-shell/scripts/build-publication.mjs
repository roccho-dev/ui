...
console.log(JSON.stringify({ schema: "artifact-shell-publication-build-receipt/3", status: "PASS", adapters: result.adapters, capabilities: result.catalog.capabilities.length, files: result.artifactManifest.files.length, treeDigest: result.artifactManifest.treeDigest }));
